  ...
  async execute(sock, msg, from, args) {
    ...
    if (!url && keyword) {
      ...
      try {
        ...
        let listMsg = theme.header(`${site.name.toUpperCase()} SEARCH`, emoji) + "\n";
        listMsg += theme.field("Query", `"${truncate(keyword, 30)}"`, "🔍") + "\n";
        ...
        listMsg += theme.divider + "\n";
        listMsg += theme.line(`👉 *Reply 1–${results.length} to select*`) + "\n";
